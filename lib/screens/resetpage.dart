...
class ResetSignInScreen extends StatefulWidget {
  const ResetSignInScreen({super.key});
  @override
  State<ResetSignInScreen> createState() => _SignInPageState();
...
Widget build(BuildContext context) {
  return Scaffold(
    ...
    body: const Center(
      child: Text('This is the Reset Password Page'),
    ),
  );
}


class _SignInPageState extends State<ResetSignInScreen> {
            ...
            Align(
              ...
              child: Column(
                children: [
                  TextButton(
                    onPressed: () {
                      // Handle Forgot Password - Navigate to ResetPasswordPage
                      debugPrint('Forgot Password pressed. Navigating to Reset Password page.');
                      context.go('/reset_password'); // Navigate to the ResetPasswordPage
                    },
                    child: Text(
                      'Forgot Password',
                      style: TextStyle(
